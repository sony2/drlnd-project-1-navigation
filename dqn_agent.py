...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        fc1_units = 64
        fc2_units = 64
        self.qnetwork_local = QNetwork(state_size, action_size, seed, fc1_units, fc2_units).to(self.device)
        self.qnetwork_target = QNetwork(state_size, action_size, seed, fc1_units, fc2_units).to(self.device)
